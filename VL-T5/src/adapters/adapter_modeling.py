...
class Adapter(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.down_sample_size = self.input_dim // reduction_factor
        self.activation = Activations(config.non_linearity.lower())
        self.conv1 = nn.Conv2d(1, 128, kernel_size=(1, 8), stride=(1, 2))  # Adjust stride here
        self.conv_up1 = nn.ConvTranspose2d(128, 1, kernel_size=(1, 8), stride=(1, 2))  # Adjust stride here
        self.track_z = config.track_z
