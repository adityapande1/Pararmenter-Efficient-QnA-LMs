...
def train(cfg: DictConfig) -> Optional[float]: 
    ...
    # Evaluate model on test set, using the best or last model from each trained fold 
        ...
        if cfg.get("test_after_training"): # and not 'simclr' in  cfg.model._target_.lower():
            ...
            sets = {
                    't2':['Datamodules_eval.Brats21','Datamodules_eval.MSLUB'], #['Datamodules_eval.Brats21'],
                   }
            ...
            for set in cfg.datamodule.cfg.testsets :
                ...
                #ckpt_dict={0:"epoch-1547_step-27863_loss-0.00_fold-1.ckpt",1:"epoch-1508_step-27161_loss-0.00_fold-2.ckpt",2:"epoch-1585_step-28547_loss-0.00_fold-3.ckpt",3:"epoch-1526_step-27485_loss-0.00_fold-4.ckpt",4:"epoch-1531_step-27575_loss-0.00_fold-5.ckpt"}
                #ckpt_dict={0:"epoch-1393_step-25091_loss-0.00_fold-1.ckpt",1:"epoch-1589_step-14309_loss-0.00_fold-2.ckpt",2:"epoch-1451_step-26135_loss-0.00_fold-3.ckpt",3:"epoch-1585_step-28547_loss-0.00_fold-4.ckpt",4:"epoch-1489_step-26819_loss-0.00_fold-5.ckpt"}
                #ckpt_path="/scratch/vivek.trivedi/bheeshm_bhaiya_experiment/patched-Diffusion-Models-UAD-main/logs/runs/DDPM_2D/trained_on_brats21/checkpoints/epoch-1510_step-107280_loss-0.00_fold-1.ckpt" 
                #ckpt_path="/scratch/vivek.trivedi/bheeshm_bhaiya_experiment/patched-Diffusion-Models-UAD-main/logs/runs/DDPM_2D_patched/checkpoint_trained_on_brats20/checkpoints/" +ckpt_dict[fold] 
                #ckpt_path="/scratch/vivek.trivedi/bheeshm_bhaiya_experiment/patched-Diffusion-Models-UAD-main/logs/runs/DDPM_2D/checkpoint_trained_on_brats20/checkpoints/"+ckpt_dict[fold] #"/scratch/vivek.trivedi/bheeshm_bhaiya_experiment/patched-Diffusion-Models-UAD-main/logs/runs/DDPM_2D_patched/DDPM_patched_2D_IXI_DDPM_2D_patched__2024-03-17_01-50-59/checkpoints/epoch-1538_step-109268_loss-0.00_fold-1.ckpt" #cfg.get('ckpt_path',None)  # "/scratch/vivek.trivedi/bheeshm_bhaiya_experiment/patched-Diffusion-Models-UAD-main/logs/runs/DDPM_2D/DDPM_2D_IXI_DDPM_2D__2024-03-15_21-49-23/checkpoints/epoch-1510_step-107280_loss-0.00_fold-1.ckpt"  #/scratch/vivek.trivedi/bheeshm_bhaiya_experiment/patched-Diffusion-Models-UAD-main/logs/runs/DDPM_2D/checkpoint_trained_on_brats20/checkpoints/+ckpt_dict[fold]
                #ckpt_path="/scratch/vivek.trivedi/bheeshm_bhaiya_experiment/patched-Diffusion-Models-UAD-main/logs/runs/DDPM_2D_patched/trained_on_brats21/checkpoints/epoch-1538_step-109268_loss-0.00_fold-1.ckpt"
                if 'train' in set:
