...
#Vivek comment : Not use in our paper 
        ...
        self.percent_updated_parameters = self.print_trainable_params_percentage(self.model) #vivek comment: showing deta
